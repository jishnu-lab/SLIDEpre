...
output: 
  html_document:
    ...
    highlight: tango
vignette: >
  %\VignetteIndexEntry{EssReg Vignette}
...
package_list <- c("matrixcalc", "readr", "ROCR", "e1071", "dplyr", "doParallel", "foreach",
                  "scales", "doRNG", "matlib", "BAS", "gmp", "clusterGeneration")
need_install <- package_list[!(package_list %in% installed.packages()[,"Package"])]
...
y_factor: F               # is y a categorical variable?
y_order: NULL             # if y is ordinal, provide the levels (Ex: ["Mild", "Moderate", "Severe"])
